...
int handle_recv_lsp(const int sock, SSL *ssl, const int server_sock, const std::function<int(int, SSL *, int, char *)> &handler) {
    ...
    const auto ret = handler(server_sock, ssl, header.id, recv_buffer);
